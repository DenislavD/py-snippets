"""Utilities for second set of flag examples, provided by Luciano Ramalho.
https://fpy.li/20-10/
"""
...
COUNTRY_CODES_FILE = Path('z_country_codes.txt')
...
def main(download_many, default_concur_req, max_concur_req):
    ...
    counter = download_many(base_url, cc_list, args.verbose, actual_req)
